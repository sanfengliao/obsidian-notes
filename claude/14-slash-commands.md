...
除了使用内置斜杠命令外，您还可以创建自己的自定义命令，这些命令可通过 SDK 使用。自定义命令定义为特定目录中的 markdown 文件，类似于子 agent 的配置方式。
...
- **[SDK 中的子 agent](13-subagents.md)**：类似的基于文件系统的子 agent 配置方式
- **[会话管理](8-sessions.md)**：了解会话 ID 和恢复机制
